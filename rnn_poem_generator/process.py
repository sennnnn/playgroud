...
from util import Tokenizer,write_dict,if_contain_char
...
write_dict(word_id_dict,'config/word_id_dict.txt')

# data block
f = open("dataset/dataset.txt", "w", encoding='utf-8')
[f.write(x+'\n') for x in poems_useful]
f.close()